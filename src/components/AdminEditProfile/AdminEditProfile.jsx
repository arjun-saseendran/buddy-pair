export const AdminEditProfile = () => {
    return (<div>
        ...
        <div className='bg-white rounded-xl shadow-xl h-[800px] w-[600px]  md:h-[600px] mx-auto mt-10'>
            ...
            <div className='grid md:grid-cols-2 mt-10 px-8 gap-8'>
                ...
                <div className="w-full flex items-center gap-2">
                    ...
                    <select className="w-20 text-gray-600 border border-gray-300 rounded-lg py-5 px-2">
                        <option className='text-gray-400' value="+91">+91</option>
                        <option value="+1">+1</option>
                    </select>


                    <div className="relative w-32">
                        <label className="text-gray-500 text-sm absolute left-3 top-2">Phone Number</label>
                        <input
                            type="text"
                            value="8023456789"
                ...
                <div className="relative w-60">
                    <label htmlFor="dropdown" className="absolute left-3 top-2 text-gray-500 text-sm">
                        Nationality
                    </label>
                    <select
                        id="dropdown"
                ...
                <div className="relative w-60">
                    ...
                    >
                        <option value="" disabled selected>Ul Intern</option>
                        <option value="option1">Option 1</option>
                        <option value="option2">Option 2</option>
                        <option value="option3">Option 3</option>
                    </select>
